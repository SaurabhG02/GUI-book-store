...
def search_command():
    list1.delete(0,END)
    for row in database.search(title_text.get(),auther_text.get(),year_text.get(),isbn_text.get()):
        list1.insert(END,row)

def add_command():
    database.insert(title_text.get(),auther_text.get(),year_text.get(),isbn_text.get())
    list1.delete(0,END)
...
def update_command():
    database.update(selected_tuple[0],title_text.get(),auther_text.get(),year_text.get(),isbn_text.get())
